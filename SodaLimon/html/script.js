...
function generateBotResponse(userMsg) {
  ...
  if (msg.includes("hola") || msg.includes("buenas")) {
    response = "¡Hola Sodero! Que tal, ¿En qué puedo ayudarte hoy?";
  }
  if (msg.includes("productos")) {
    response = "Tenemos refrescos como RedSpark, BlueFizz, Agua Vip, Kola Tigrina, Red Grape y Limón Soul, entre otras. 🍋.";
  }
